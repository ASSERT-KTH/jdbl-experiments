...
For the rest of the analysis, we exclude the libs for which the debloat fail.
The current number of Libs, Versions, and Clients in the dataset are:
...
lib_classes_area <- data %>% 
  ...
  scale_x_continuous(limits = c(0, 119), 
                     breaks=c(1, 25 , 50, 75, 100, (nrow(data)/2)),
